...
menuItem3 = MenuItem(name = "Gyoza", description = "The most prominent differences between Japanese-style gyoza and Chinese-style jiaozi are the rich garlic flavor and the light seasoning of Japanese gyoza with salt and soy sauce.", price = "$9.95", course = "Entree", restaurant = restaurant1)
